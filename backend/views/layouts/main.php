		...
		<div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="/" class="site_title"><span><?php echo Yii::$app->request->hostInfo;?></span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> <?php echo \Yii::t('/yii','Menu')?> <span class="fa fa-chevron-down"></span></a>
...
<footer class="footer">
    <div class="container">
        <p class="pull-left">&copy; My Company  <?= Url::home(true); ?></p>
